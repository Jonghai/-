...
public class EgovSessionCookieUtil {
	...
	public static SessionVO getAdminUserSession() {
		return (SessionVO)RequestContextHolder.getRequestAttributes().getAttribute("adminuser", RequestAttributes.SCOPE_SESSION);
	}
}